...
def load_agent_and_create_gif(checkpoint_dir, env_name, num_frames=1000, fps=30, checkpoint_num:int=9):
    checkpoint_dir += f'_{checkpoint_num}'
    ...
    create_gif(frames, f'agent_performance_{checkpoint_num}.gif', fps)
...
if __name__ == "__main__":
    ...
    for i in range(10):
        load_agent_and_create_gif(checkpoint_dir, env_name, checkpoint_num=i)